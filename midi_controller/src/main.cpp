...
CCButton DelayType = {A8, {MIDI_CC::General_Purpose_Controller_4, Channel_10}};
...
CCButton GrainType = {A14, {MIDI_CC::General_Purpose_Controller_5, Channel_4}};
CCButton GrainPlayback = {A15, {MIDI_CC::General_Purpose_Controller_5, Channel_5}};
